        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbar_global">
                ...
                <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                    <li class="nav-item">
                        <a href="<?= base_url(); ?>" class="nav-link" role="button">
                ...
                <div class="card card-profile shadow mt--300">
                    <div class="px-4">
                        <div class="row justify-content-center">
                            <div class="col-lg-3 order-lg-2">
                                <div class="card-profile-image mt-3">
                                    <a href="javascript:;">
                                        <img src="<?= base_url(); ?>assets/img/faces/team-1.jpg" class="rounded-circle" width="170" height="170">
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div class="text-center mt-9">
                            <h3>Harlequin</h3>
                            <div class="h6 font-weight-300">harle@quin.oke</div>
                        </div>
                        <div class="mt-5 py-5 border-top text-center">
                            <div class="row justify-content-center">
                                <div class="col-lg-9">
                                    <form role="form" method="post" enctype="multipart/form-data">
                                        <input value="<?= base_url(); ?>" type="hidden" name="id">
                                        <input value="<?= base_url(); ?>" type="hidden" name="old_avatar">
                                        <div class="form-group mb-3">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" value="<?= base_url(); ?>" type="text" name="username" required>
                                            </div>
                                        </div>
                                        <div class="form-group mb-3">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" value="<?= base_url(); ?>" type="email" name="email" required>
                                            </div>
                                        </div>
