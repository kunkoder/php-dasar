...
<body class="profile-page">
    ...
    <nav id="navbar-main"
        ...
        <div class="container">
            <a class="navbar-brand mr-lg-5" href="admin">
                                    ...
                                    <form role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" value="Harlequin" type="text"
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" value="harle@quin.oke" type="email"
                                                    name="email" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center">
                                            <a class="nav-link" href="admin">Kembali</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
